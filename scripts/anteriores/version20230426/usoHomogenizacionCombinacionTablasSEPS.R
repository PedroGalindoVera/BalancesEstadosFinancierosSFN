...
source("scripts/herramientasDecargaTablasBalanceFinanciero.R")
...
descargaArchivosEnlacesAnalizados(enlacesSEPS, informacionSEPS, "SEPS")
...
# enlacesSB <- analisisVinvulosDirectorioWebSB()
# 
# informacionSB <- obtencionEnlacesDescarga(enlaces_descarga = enlacesSB, identificador = "SB")
# 
# descargaArchivosEnlacesAnalizados(enlacesSB, informacionSB, "SB")
# 
# descompresionArchivos(origen = "data/Descargas/SB", destino = "data/Fuente/SB")

descompresionArchivosSB(origen = "data/Descargas/SB/Boletin Financiero Mensual", destino = "data/Fuente/SB", num_archivo = 100)
descompresionArchivosSB(origen = "data/Descargas/SB/Boletin Financiero Mensual", destino = "data/Fuente/SB", num_archivo = 100+2)
descompresionArchivosSB(origen = "data/Descargas/SB/Boletin Financiero Mensual", destino = "data/Fuente/SB", num_archivo = 100+2+97)
descompresionArchivosSB(origen = "data/Descargas/SB/Boletin Financiero Mensual", destino = "data/Fuente/SB", num_archivo = 100+2+97+1)


##### Descompresión Total #####

descompresionDirectorio(origen = "data/Descargas", destino = "data/Fuente")


#### Importación y manipulación de tablas de datos ####

#source("scripts/importacionModificacionTablasSEPS.R")
source("scripts/herramientasImportacionModificacionTablasSEPS.R")
