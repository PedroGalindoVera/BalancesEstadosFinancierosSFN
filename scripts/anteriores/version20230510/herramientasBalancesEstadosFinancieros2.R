...
descargarBoletinesFinancierosSB <- function(ruta_archivo_html) {
  ...
  for (k in seq_along(download_links_elegidos) ) {
    ...
    ruta_archivo <- file.path(directorio_carpeta, nombre_archivo)
...
compilarHojasBalanceFinancieroSB <- function(ruta_directorio = NULL) {
  ...
  if ( is.null(ruta_directorio) ) ruta_directorio <- "data/Descargas/SB/Boletines Financieros Mensuales"
...
crearBalancesFinancierosSB <- function() {
  ...
  ejecutarDescargaBoletinesFinancierosSB()
  ...
  ruta_directorio_privada = "data/Descargas/SB/Boletines Financieros Mensuales/Bancos Privados"
  ...
  ruta_directorio_publica = "data/Descargas/SB/Boletines Financieros Mensuales/Instituciones Publicas"
