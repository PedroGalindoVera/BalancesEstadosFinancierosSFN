...
creacionDirectorio <- function(directorio_base = getwd(), nueva_ruta) {
  # Ejemplo: creacionDirectorio(nueba_ruta = "data")
  # Ejemplo: creacionDirectorio(directorio_base = "data", nueva_ruta = "data/Descargas")
...
descargaArchivosEnlacesAnalizados <- function(enlaces, informacion, identificador) {
  ...
  creacionDirectorio(nueva_ruta = "data")
  
  creacionDirectorio(directorio_base = "data", nueva_ruta = "data/Descargas")
  
  creacionDirectorio(directorio_base = "data", nueva_ruta = desc_dir)
...
descompresionArchivos <- function(origen, destino) {
  ...
  creacionDirectorio(directorio_base = "data", nueva_ruta = "data/Fuente")
  
  # Establecer el directorio de destino para los archivos Descromprimidos
  creacionDirectorio(directorio_base = "data/Fuente", nueva_ruta = destino)
