...
fusionarBalancesSBEstadosSEPSFinancieros <- function() {
  ...
  SEPS <- crearEstadosFinancierosSEPS() # Verificado en prueba individual 2023/05/11
  SB <- crearBalancesFinancierosSB() # Verificado en prueba individual 2023/05/11
  BEF <- rbind(SEPS, SB)
  ...
  # ruta_archivo_compartido <- paste(ruta_directorio_compartido, nombre_archivo, sep = "\\")
