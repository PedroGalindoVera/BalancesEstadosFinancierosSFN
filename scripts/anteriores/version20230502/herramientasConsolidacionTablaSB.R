# verificadorInstalacion0 <- function(ruta_intalacion) {----
#   
...
#   script <- c("-Command", paste0("if (Test-Path ", ruta_intalacion, ") { $true }"))
...
#     script <- paste("powershell -command Start-Process", file_path, "-ArgumentList '/S' -Verb runAs")
